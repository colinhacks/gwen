...
// export class Gwen<Params extends GwenParams> extends GwenBase<Params> {
...
//   get shadow3() { return this.css({ boxShadow: "0 3px 5px 0 rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.06);" }); }
//   get shadow4() { return this.css({ boxShadow: "0 5px 8px 0 rgba(0, 0, 0, 0.1), 0 3px 3px 0 rgba(0, 0, 0, 0.06);" }); }
//   get shadow5() { return this.css({ boxShadow: "0 8px 11px 0 rgba(0, 0, 0, 0.1), 0 5px 5px 0 rgba(0, 0, 0, 0.06);" }); }
//   get shadow6() { return this.css({ boxShadow: "0 11px 17px 0 rgba(0, 0, 0, 0.1), 0 8px 8px 0 rgba(0, 0, 0, 0.06);" }); }
//   get shadow7() { return this.css({ boxShadow: "0 17px 26px 0 rgba(0, 0, 0, 0.1), 0 11px 11px 0 rgba(0, 0, 0, 0.06);" }); }
...
//   get fw1() { return this.css({ fontWeight: 100 })}
//   get fw2() { return this.css({ fontWeight: 200 })}
//   get fw3() { return this.css({ fontWeight: 300 })}
//   get fw4() { return this.css({ fontWeight: 400 })}
//   get fw5() { return this.css({ fontWeight: 500 })}
//   get fw6() { return this.css({ fontWeight: 600 })}
//   get fw7() { return this.css({ fontWeight: 700 })}
//   get fw8() { return this.css({ fontWeight: 800 })}
//   get fw9() { return this.css({ fontWeight: 900 })}
